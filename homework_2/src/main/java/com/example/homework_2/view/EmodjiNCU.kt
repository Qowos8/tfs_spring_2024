...
// Travel & Places
    ...
    EmojiNCU("stopwatch", 0x23f1),
    EmojiNCU("timer", 0x23f2),
...
// Objects
    ...
    EmojiNCU("mine", 0x26cf),
    EmojiNCU("at_work", 0x2692),
    EmojiNCU("working_on_it", 0x1f6e0),
    EmojiNCU("dagger", 0x1f5e1),
    EmojiNCU("duel", 0x2694),
    ...
    EmojiNCU("gear", 0x2699),
    EmojiNCU("compression", 0x1f5dc),
    EmojiNCU("justice", 0x2696),
    EmojiNCU("link", 0x1f517),
    EmojiNCU("chains", 0x26d3),
    EmojiNCU("alchemy", 0x2697),
    ...
    EmojiNCU("coffin", 0x26b0),
    EmojiNCU("funeral_urn", 0x26b1),
...
// Symbols
    ...
    EmojiNCU("radioactive", 0x2622),
    EmojiNCU("biohazard", 0x2623),
    EmojiNCU("up", 0x2b06),
    EmojiNCU("upper_right", 0x2197),
    EmojiNCU("right", 0x27a1),
    EmojiNCU("lower_right", 0x2198),
    EmojiNCU("down", 0x2b07),
    EmojiNCU("lower_left", 0x2199),
    EmojiNCU("left", 0x2b05),
    EmojiNCU("upper_left", 0x2196),
    EmojiNCU("up_down", 0x2195),
    EmojiNCU("left_right", 0x2194),
    EmojiNCU("reply", 0x21a9),
    EmojiNCU("forward", 0x21aa),
    EmojiNCU("heading_up", 0x2934),
    EmojiNCU("heading_down", 0x2935),
    ...
    EmojiNCU("atom", 0x269b),
    EmojiNCU("om", 0x1f549),
    EmojiNCU("star_of_david", 0x2721),
    EmojiNCU("wheel_of_dharma", 0x2638),
    EmojiNCU("yin_yang", 0x262f),
    EmojiNCU("cross", 0x271d),
    EmojiNCU("orthodox_cross", 0x2626),
    EmojiNCU("star_and_crescent", 0x262a),
    EmojiNCU("peace", 0x262e),
    ...
    EmojiNCU("play", 0x25b6),
    EmojiNCU("fast_forward", 0x23e9),
    EmojiNCU("next_track", 0x23ed),
    EmojiNCU("play_pause", 0x23ef),
    EmojiNCU("play_reverse", 0x25c0),
    EmojiNCU("rewind", 0x23ea),
    EmojiNCU("previous_track", 0x23ee),
    ...
    EmojiNCU("multiplication", 0x2716),
    EmojiNCU("plus", 0x2795),
    EmojiNCU("minus", 0x2796),
    EmojiNCU("division", 0x2797),
    EmojiNCU("bangbang", 0x203c),
    EmojiNCU("interrobang", 0x2049),
    EmojiNCU("question", 0x2753),
    EmojiNCU("grey_question", 0x2754),
    EmojiNCU("grey_exclamation", 0x2755),
    EmojiNCU("exclamation", 0x2757),
    EmojiNCU("wavy_dash", 0x3030),
    EmojiNCU("exchange", 0x1f4b1),
    EmojiNCU("dollars", 0x1f4b2),
    EmojiNCU("recycle", 0x267b),
    EmojiNCU("fleur_de_lis", 0x269c),
    EmojiNCU("trident", 0x1f531),
    EmojiNCU("name_badge", 0x1f4db),
    EmojiNCU("beginner", 0x1f530),
    EmojiNCU("circle", 0x2b55),
    EmojiNCU("check", 0x2705),
    EmojiNCU("checkbox", 0x2611),
    EmojiNCU("check_mark", 0x2714),
    EmojiNCU("cross_mark", 0x274c),
    EmojiNCU("x", 0x274e),
    EmojiNCU("loop", 0x27b0),
    EmojiNCU("double_loop", 0x27bf),
    EmojiNCU("part_alternation", 0x303d),
    EmojiNCU("eight_spoked_asterisk", 0x2733),
    EmojiNCU("eight_pointed_star", 0x2734),
    EmojiNCU("sparkle", 0x2747),
    EmojiNCU("tm", 0x2122),
    EmojiNCU("hash", 0x0023),
    EmojiNCU("asterisk", 0x002a),
    EmojiNCU("zero", 0x0030),
    EmojiNCU("one", 0x0031),
    EmojiNCU("two", 0x0032),
    EmojiNCU("three", 0x0033),
    EmojiNCU("four", 0x0034),
    EmojiNCU("five", 0x0035),
    EmojiNCU("six", 0x0036),
    EmojiNCU("seven", 0x0037),
    EmojiNCU("eight", 0x0038),
    EmojiNCU("nine", 0x0039),
    EmojiNCU("ten", 0x1f51f),
    ...
    EmojiNCU("info", 0x2139),
    EmojiNCU("id", 0x1f194),
    EmojiNCU("metro", 0x24c2),
    EmojiNCU("new", 0x1f195),
    EmojiNCU("ng", 0x1f196),
    EmojiNCU("o", 0x1f17e),
    EmojiNCU("squared_ok", 0x1f197),
    EmojiNCU("parking", 0x1f17f),
    ...
    EmojiNCU("black_medium_square", 0x25fc),
    EmojiNCU("white_medium_square", 0x25fb),
    EmojiNCU("black_medium_small_square", 0x25fe),
    EmojiNCU("white_medium_small_square", 0x25fd),
    EmojiNCU("black_small_square", 0x25aa),
    EmojiNCU("white_small_square", 0x25ab),
